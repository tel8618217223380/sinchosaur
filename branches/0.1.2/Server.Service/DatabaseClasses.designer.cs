...
namespace Server.Service
{
	...
	partial void OnIsActualChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Directory_File", Storage="_Directory", ThisKey="DirectoryId", OtherKey="DirectoryId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
	...
	partial void OnCreatedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Directory_File", Storage="_File", ThisKey="DirectoryId", OtherKey="DirectoryId")]
